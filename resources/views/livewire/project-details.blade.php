<main class="py-10 bg-gray-50 dark:bg-gray-800">
    ...
    <div
            ...
            <div class="shrink-0">
                <div class="relative">
                    <img
                        ...
                        src="{{ $project->accountManager->monday_photo_url }}"
        ...
        <div
            ...
            <a
                href="https://www.local-marketing-reports.com/location-dashboard/c567222026bcf219cee102a98dc43fd811bdd61c/summary"
                target="_blank"
    ...
    <div
        class="mx-auto mt-8 max-w-7xl grid grid-cols-1 gap-6 sm:px-6 lg:grid-cols-12">
                    ...
                    <div class="px-6 py-6 sm:px-6">
                        <dl class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
                            ...
                            <div class="sm:col-span-2">
                                <dt class="text-sm font-semibold text-gray-700 dark:text-gray-300">Shared Success Goal</dt>
                                <dd class="mt-1 text-sm text-gray-900 dark:text-gray-100">
        ...
        <section aria-labelledby="timeline-title" class="lg:col-span-4">
            <div class="bg-white p-6 shadow-sm rounded-lg dark:bg-gray-700">
                    ...
                    <ul role="list" class="-mb-8">
                        ...
                        <li>
                            <div class="relative pb-6">
                                <span
                                    class="absolute top-4 left-4 -ml-px h-full w-1.5 bg-gray-200 dark:bg-gray-600"
                                    aria-hidden="true"></span>
                                <div class="relative flex items-center space-x-3">
                                    <div>
                                        <span class="flex h-8 w-8 items-center justify-center rounded-full bg-green-500 ring-8 ring-white dark:ring-gray-700">
                                            <svg
                                    ...
                                    <div class="flex min-w-0 flex-1 flex-col space-y-1 pl-4">
                                        <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">Onboarding</p>
                        ...
                        <li>
                            <div class="relative pb-6">
                                ...
                                <div class="relative flex items-center space-x-3">
                                    ...
                                    <div class="flex min-w-0 flex-1 flex-col space-y-1 pl-4">
                                        <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">SEO Project</p>
                        ...
                        <li>
                            <div class="relative pb-6">
                                ...
                                <div class="relative flex items-center space-x-3">
                                    <div>
                                        <span class="flex h-8 w-8 items-center justify-center rounded-full bg-blue-500 ring-8 ring-white dark:bg-blue-700 dark:ring-gray-700">
                                            <svg
                                                class="h-4 w-4 text-white"
                                                viewBox="0 0 20 20"
                                                fill="currentColor"
                                    ...
                                    <div class="flex min-w-0 flex-1 flex-col space-y-1 pl-4">
                                        <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">Website Project</p>
                        ...
                        <li>
                            <div class="relative">
                                <div class="relative flex items-center space-x-3">
                                    <div>
                                        <span class="flex h-8 w-8 items-center justify-center rounded-full bg-gray-300 ring-8 ring-white dark:bg-gray-600 dark:ring-gray-700">
                                            <svg
                                    ...
                                    <div class="flex min-w-0 flex-1 flex-col space-y-1 pl-4">
                                        <p class="text-sm font-semibold text-gray-700 dark:text-gray-300">Branding Project</p>
                ...
                <div class="mt-14">
                    <a
                        href="{{ route('project.map', ['uuid' => $project->id ?? 'default-uuid']) }}"
                        class="inline-flex items-center justify-center rounded-md bg-orange-600 px-4 py-2 text-sm font-medium text-white shadow hover:bg-orange-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-orange-500">
                        Project Gantt Chart
                    </a>
                </div>
