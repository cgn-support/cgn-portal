<div>
    ...
    <div class="mb-8">
        ...
        <p class="text-gray-600 mt-2">Track and manage your marketing leads to understand campaign performance and ROI
        </p>
    </div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-5 gap-6 mb-8">
        ...
        <div class="agency-card p-6 text-center">
            <div class="mb-2">
                <div
                    class="w-12 h-12 bg-gradient-to-br from-purple-400 to-purple-600 rounded-full mx-auto flex items-center justify-center">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        <div class="agency-card p-6 text-center">
            <div class="mb-2">
                <div
                    class="w-12 h-12 bg-gradient-to-br from-orange-400 to-orange-600 rounded-full mx-auto flex items-center justify-center">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
        ...
        @if ($showLeadModal && $selectedLead)
            <div class="fixed inset-0 z-50 overflow-y-auto" aria-labelledby="modal-title" role="dialog"
                ...
                <div class="flex items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
                    <div class="fixed inset-0 bg-gray-500 bg-opacity-75 transition-opacity" wire:click="closeLeadModal">
                    </div>
                                    ...
                                    <div class="space-y-4 mb-6">
                                        <div>
                                            <label class="block text-sm font-medium text-gray-700">Contact
                                                Information</label>
                                            <div class="mt-1 p-3 bg-gray-50 rounded-full">
                                                <div class="text-sm">
                                                    <div><strong>Name:</strong> {{ $selectedLead->name ?: 'Not provided' }}
                                                    </div>
                                                    <div><strong>Email:</strong>
                                                        {{ $selectedLead->email ?: 'Not provided' }}</div>
                                        ...
                                        @if ($selectedLead->message)
                                            <div>
                                                ...
                                                <div class="mt-1 p-3 bg-gray-50 rounded-full text-sm">
                                            ...
                                            <div class="mt-1 p-3 bg-gray-50 rounded-full text-sm">
                                                @if ($selectedLead->utm_source)
                                                    ...
                                                    @if ($selectedLead->utm_campaign)
                                                        <div><strong>Campaign:</strong> {{ $selectedLead->utm_campaign }}
                                                        </div>
                                                    @endif
                                                @else
                                                    Direct traffic
                                        ...
                                        @if ($selectedLead->status === 'valid')
                                            <div>
                                                <label for="lead-value"
                                                    class="block text-sm font-medium text-gray-700">Lead Value ($)</label>
                                                <input type="number" step="0.01" wire:model="leadValue"
                                                    id="lead-value"
                                                    class="mt-1 block w-full rounded-full border-gray-300 shadow-sm focus:border-orange-500 focus:ring-orange-500"
                        ...
                        <div class="bg-gray-50 px-4 py-3 sm:px-6 sm:flex sm:flex-row-reverse">
                            @if ($selectedLead->status === 'valid')
                                <button type="button" wire:click="markAsClosed"
                                    class="w-full inline-flex justify-center rounded-full border border-transparent shadow-sm px-4 py-2 bg-purple-600 text-base font-medium text-white hover:bg-purple-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 sm:ml-3 sm:w-auto sm:text-sm">
                                    Mark as Closed
                                </button>
                            @endif
