        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div class="flex items-center justify-between">
                ...
                <div class="flex space-x-3">
                    ...
                    <a href="https://www.local-marketing-reports.com/location-dashboard/c567222026bcf219cee102a98dc43fd811bdd61c/summary" target="_blank"
            ...
            <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm p-6">
                ...
                <dl class="space-y-4">
                    <div class="flex justify-between">
                        ...
                        <dd class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $quickStats['tasks'] }}</dd>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <dd class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $quickStats['leads'] }}</dd>
                    </div>
                    <div class="flex justify-between">
                    ...
                    <div class="flex justify-between">
                        ...
                        <dd class="text-sm font-semibold text-gray-900 dark:text-gray-100">{{ $quickStats['reports'] }}</dd>
                    </div>
                    <div class="flex justify-between">
                        <dt class="text-sm font-medium text-gray-500 dark:text-gray-400">Lead Value</dt>
                        <dd class="text-sm font-semibold text-green-600">${{ number_format($quickStats['total_lead_value'], 0) }}</dd>
                    </div>
                </dl>
            </div>
                        ...
                        <div class="flex items-center space-x-3">
                            ...
                            <div class="flex-shrink-0">
                                ...
                                @elseif($stage['is_active'])
                                    <div class="w-8 h-8 bg-{{ $stage['color'] }}-500 rounded-full flex items-center justify-center">
        ...
        <div class="bg-white dark:bg-gray-800 rounded-lg shadow-sm" x-data="{ showAttachments: false }">
            <div class="px-6 py-4 border-b border-gray-200 dark:border-gray-700">
                <button @click="showAttachments = !showAttachments" 
                    ...
                    <svg x-show="!showAttachments" class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div x-show="showAttachments" class="px-6 py-4">
                <ul class="space-y-3">
                    <li class="flex items-center justify-between">
                        ...
                        <a href="#" class="text-indigo-600 hover:text-indigo-500 text-sm font-medium">Download</a>
                    </li>
                    <li class="flex items-center justify-between">
                        <div class="flex items-center space-x-3">
                            <svg class="w-5 h-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
