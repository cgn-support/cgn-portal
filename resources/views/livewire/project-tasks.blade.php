<div>
    ...
    <div class="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
        ...
        <div class="agency-card p-6 text-center">
            <div class="mb-2">
                <div class="w-12 h-12 bg-gradient-to-br from-red-400 to-red-600 rounded-full mx-auto flex items-center justify-center">
                    <svg class="w-6 h-6 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    <div class="space-y-4">
        @forelse($tasks as $task)
            <div class="agency-card p-6 {{ $task->status === 'overdue' ? 'border-l-4 border-red-500' : '' }} {{ $task->status === 'completed' ? 'opacity-75' : '' }}">
