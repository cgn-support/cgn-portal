<div class="space-y-4">
        ...
        <div class="bg-white shadow-sm rounded-lg p-4 hover:shadow-md transition-shadow duration-200">
            <a href="{{ $post['link'] }}" target="_blank" class="block group">
                <div class="flex items-start gap-4">
                    ...
                    @else
                        <div class="w-20 h-20 bg-gray-200 flex items-center justify-center rounded-md flex-shrink-0">
    ...
    @empty
        <div class="text-center py-8">
            ...
            <p class="mt-1 text-sm text-gray-500">No posts were published during {{ \Carbon\Carbon::parse($month)->format('F Y') }}</p>
        </div>
    @endforelse
</div>
